...
LayerPinch = (function(superClass) {
  ...
  LayerPinch.prototype._calculateDistance = function(event) {
    ...
    this._distance = _distances.slice(-1)[0] - _distances.slice(0, 1)[0];
    return this._totalDistance = this.previousTotalDistance + this.distance;
  };
  ...
  LayerPinch.prototype._endValues = function() {
    ...
    this._previousTotalDistance = this.totalDistance;
    _fingers = [];
    _distances = [];
    _angles = [];
    return _midPoints = [];
  ...
  LayerPinch.define("previousTotalDistance", {
    get: function() {
      return this._previousTotalDistance || 0;
    },
    set: function(value) {
      return this._previousTotalDistance = value;
    }
  });
